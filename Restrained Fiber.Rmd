...
pltmaindir<-"~/Documents/Research/MRSEC/CSH-CSSC/Restrained fiber/Ind_Plt/"
...
fibdist[[2]]<-fibdist[[2]][-which(fibdist[[2]]$Freq<=max(fibdist[[2]]$Freq) & fibdist[[2]]$z >150),]
  ...
  if (1) {
    if (L==1) {
        ggsave(paste0(pltmaindir,subdir,"/legend.png"),
...
if (savept) {
  if (!dir.exists(paste0(pltmaindir,subdir))) {
    dir.create(paste0(pltmaindir,subdir))
  }
  ggsave(paste0(pltmaindir,subdir,"/Mix_CoorZ.png"),
         plot=heavy_rho_z2, dpi=1100, 
         width=8, height=4.3,units="cm")
  ggsave(paste0(pltmaindir,subdir,"/Mix_CoorR.png"),
         plot=heavy_rho_r2, dpi=1100, 
         width=8, height=4.3,units="cm")
  ggsave(paste0(pltmaindir,subdir,"/Cylcssc_Mix_CoorZ.png"),
         plot=heavy_rho_z1, dpi=1100,
         width=8, height=4.3,units="cm")
  ggsave(paste0(pltmaindir,subdir,"/Cylcssc_Mix_CoorR.png"),
         plot=heavy_rho_r1, dpi=1100,
         width=8, height=4.3,units="cm")
  ggsave(paste0(pltmaindir,subdir,"/Pure_CoorZ.png"),
         plot=heavy_rho_z3, dpi=1100, 
         width=8, height=4.3,units="cm")
  ggsave(paste0(pltmaindir,subdir,"/Pure_CoorR.png"),
...
if (savept) {
  ...
  ggsave(paste0(pltmaindir,subdir,"/mixdensityplt.png"),
         plot=mixdensityplt+theme(legend.position = "none"), dpi=1100, 
         width=8.6, height=4.3,units="cm")
  ggsave(paste0(pltmaindir,subdir,"/puredensityplt.png"),
         plot=puredensityplt+theme(legend.position = "none"), dpi=1100, 
         width=8.6, height=4.3,units="cm")
  ggsave(paste0(pltmaindir,subdir,"/mixdensityCSSCplt.png"),
...
if (savept) {
  ...
  ggsave(paste0(pltmaindir,subdir,"/densityplt.png"),
         plot=fib_rho_plt, dpi=1100, 
         width=8.6*2, height=2*5,units="cm")
  ggsave(paste0(pltmaindir,subdir,"/fiber_sizeplt.png"),
...
subdir<-"phe-phe_dis/"
RdataName<-c(
  "/Users/song/Documents/Research/HPC/dfs2/mrsec/CSH-CSSC/cyl1/mix_27A/analysis/data/mix_27A_cylcssc_fibre_PHEdis_R+_12to29_every100.rda"
  ,
  "/Users/song/Documents/Research/HPC/dfs2/mrsec/CSH-CSSC/cyl1/mix_27A/analysis/data/mix_27A_fibre_PHEdis_SS12to38_every100.rda"
  ,
...
for (L in 1:3) {
  ...
  # Ensure correct order and compute xmin and xmax from Rbreaks
HistMatrixROut_long <- {
  HistMatrixROut_long %>%
    arrange(R) %>%
    mutate(
        xmin = Rbreaks[match(R, Rbreaks) ],  # Previous bin edge
        xmax = Rbreaks[match(R, Rbreaks)+1],      # Current bin edge
        ymin = D,
        ymax = lead(D, default = max(D) + diff(range(D))/length(D))  # Ensure proper tile height
    ) %>%
    filter(!is.na(xmin) & !is.na(xmax))  # Remove any NA values
}
# Ensure xmax > xmin (correct errors if needed)
HistMatrixROut_long <- {HistMatrixROut_long %>%
    mutate(
        xmin = ifelse(is.na(xmin), min(Rbreaks), xmin),
        xmax = ifelse(is.na(xmax), max(Rbreaks), xmax)
    )
}
  HistMatrixROut_long$Pr[HistMatrixROut_long$Pr==0]=NA
  PheDisRPlt<-{
    ggplot(HistMatrixROut_long, aes(fill = Pr*100 )) +
    geom_rect(aes(
    ...
    scale_fill_gradientn(
      ...
      labs(
        ...
        fill=expression("Number Density (×10"^-2~"/Å"^3~")"),#paste0(PltTypenameType,"\nNumber Density\n(/Å³)"),
...
if (savept) {
  ...
  ggsave(paste0(pltmaindir,subdir,"MixCSSCpheDis.png"),
         plot=PheDisRPlt1, dpi=1100, 
         width=8.6, height=4.3,units="cm")
  ggsave(paste0(pltmaindir,subdir,"MixpheDis.png"),
         plot=PheDisRPlt2, dpi=1100, 
         width=8.6, height=4.3,units="cm")
  ggsave(paste0(pltmaindir,subdir,"PurepheDis.png"),
...
for (L in 1:3) {
  ...
  AbsOrientRplt<-{
    ...
    if (L==1) {
    ggsave(paste0(pltmaindir,subdir,"/legendR.png"),
  ...
  if (L==1) {
    ggsave(paste0(pltmaindir,subdir,"/legendZ.png"),
  ...
  if (savept) {
    ...
    # ggsave(paste0(pltmaindir,subdir,plotnameprefix,"OriZ.png"),
    #        plot=OrientZplt, dpi=1100, 
    #        width=8.6, height=4.3,units="cm")
    # ggsave(paste0(pltmaindir,subdir,plotnameprefix,"OriR.png"),
    #        plot=OrientRplt, dpi=1100, 
    #        width=8.6, height=4.3,units="cm")
    ggsave(paste0(pltmaindir,subdir,plotnameprefix,"AbsOriZ.png"),
           plot=AbsOrientZplt, dpi=1100, 
...
fill=paste0("Number Density (xE-7/Å³)"),
  ...
  if (savept) {
    ...
    ggsave(paste0(pltmaindir,subdir,plotnameprefix,"AbsOriZ.png"),
           plot=AbsOrientZplt, dpi=1100, 
           width=8.6, height=4.3*1.3,units="cm")
    ggsave(paste0(pltmaindir,subdir,plotnameprefix,"AbsOriR.png"),
           plot=AbsOrientRplt, dpi=1100, 
           width=8.6, height=4.3*1.3,units="cm")
  }
  assign(paste0("OrientZplt",L),OrientZplt)
...
if (savept) {
  ggsave(paste0(pltmaindir,subdir,"PiCountPlt.png"),
         plot=PiCountPlt, dpi=1100, 
         width=2*8.6, height=2*4.3,units="cm")
  ggsave(paste0(pltmaindir,subdir,"Pure_Pi_Dis_Z.png"),
         plot=PiDistPltZ1, dpi=1100,
         width=8.2, height=4.3,units="cm")
  ggsave(paste0(pltmaindir,subdir,"Pure_Pi_Dis_R.png"),
         plot=PiDistPltR1, dpi=1100,
         width=8.2, height=4.3,units="cm")
  ggsave(paste0(pltmaindir,subdir,"Mix_Pi_Dis_Z.png"),
         plot=PiDistPltZ3, dpi=1100,
         width=8.2, height=4.3,units="cm")
  ggsave(paste0(pltmaindir,subdir,"Mix_Pi_Dis_R.png"),
         plot=PiDistPltR3, dpi=1100,
         width=8.2, height=4.3,units="cm")
  ggsave(paste0(pltmaindir,subdir,"Cylcssc_Pi_Dis_Z.png"),
         plot=PiDistPltZ2, dpi=1100,
         width=8.2, height=4.3,units="cm")
  ggsave(paste0(pltmaindir,subdir,"Cylcssc_Pi_Dis_R.png"),
...
for (L in 1:3) {
  ...
  for (coortype in c("R","Z")) {
    ...
    if (savept) {
      ggsave(paste0(pltmaindir,subdir,SysPrefix,"_Hbond_",coortype,".png"),
             plot=CoorDisTempPlt, dpi=1100,
             width=8.2, height=4.3,units="cm")
    }
  }
  ...
  if (savept) {
    ggsave(paste0(pltmaindir,subdir,SysPrefix,"_Hbond_Count.png"),
...
if (savept) {
  ...
  ggsave(paste0(pltmaindir,subdir,"HbondCountPlt.png"),
...
for (plot_name in names(plots_long)) {
  ...
  print(plotly_plot)
  ggsave(paste0(pltmaindir,subdir,SysPrefix,"_",plot_name,".png"),
...
for (plot_name in names(plots_original)) {
  plotly_plot <- ggplotly(plots_original[[plot_name]])
  print(plotly_plot)
  ggsave(paste0(pltmaindir,subdir,plot_name,".png"),
           plot=plots_original[[plot_name]], dpi=1100,
           width=8.6*2, height=2*4.3*1.3,units="cm")
}
ggsave(paste0(pltmaindir,subdir,"HbondCount_TIP3.png"),
...
for (dir in dirs) {
  full_path <- paste0(pltmaindir, subdir, "/", dir)
...
for (i in 1:length(names(plots_all))) {
  ...
  print(plotly_plot)
  ggsave(paste0(pltmaindir, subdir, "/All/", i, ".png"),
...
, dpi = 1100,
 ...
 for (i in 1:length(names(plots_resname))) {
  ...
  print(plotly_plot)
  ggsave(paste0(pltmaindir, subdir, "/CSH_CSSC/", i, ".png"),
...
for (i in 1:length(names(plots_AMindex))) {
  ...
  print(plotly_plot)
  ggsave(paste0(pltmaindir, subdir, "/AMIDE/", i, ".png"),
...
if (savept) {
  ...
  ggsave(paste0(pltmaindir,subdir,"MixFibercontact_atom.png"),
         plot=contact_plt1, dpi=1100, 
         width=8.6*2, height=4.3*2,units="cm")
  ggsave(paste0(pltmaindir,subdir,"Mixcontact_atom.png"),
         plot=contact_plt2, dpi=1100, 
         width=8.6*2, height=4.3*2,units="cm")
  ggsave(paste0(pltmaindir,subdir,"PureFibercontact_atom.png"),
         plot=contact_plt3, dpi=1100, 
         width=8.6*2, height=4.3*2,units="cm")
  ggsave(paste0(pltmaindir,subdir,"Purecontact_atom.png"),
         plot=contact_plt4+
...
if (savept) {
  ggsave(paste0(pltmaindir,subdir,"1D Free Energy of Solvation.png"),
...
if (savept) {
  ggsave(paste0(pltmaindir,subdir,"Free Energy of Solvation 2D.png"),
...
if (savept) {
  ...
  ggsave(paste0(pltmaindir,subdir,"Hbond_dis_R.png"),
...
if (savept) {
  ...
  ggsave(paste0(pltmaindir,subdir,"Mix_Pi_Dis_R.png"),
         ...
         width=8.6, height=4.3,units="cm")
  ggsave(paste0(pltmaindir,subdir,"Cylcssc_Mix_Pi_Dis_Z.png"),
         plot=CSSCMixPiDistPltZ, dpi=1100, 
         width=8.6, height=4.3,units="cm")
  ggsave(paste0(pltmaindir,subdir,"Cylcssc_Mix_Pi_Dis_R.png"),
  ...
  ggsave(paste0(pltmaindir,subdir,"Pure_Pi_Dis_R.png"),
         ...
         width=8.6, height=4.3,units="cm")
  orca(PurePiContourPltFibre,paste0(pltmaindir,subdir,"Pure_Pi_Dis_Ang.png"))
  ggsave(paste0(pltmaindir,subdir,"PiCountPlt.png"),
         plot=PiCountPlt, dpi=1100, 
         width=2*8.6, height=2*4.3,units="cm")
}
